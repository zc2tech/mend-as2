...
/**
 * Table model for user-specific IP whitelist entries
 * Identical structure to TableModelPartnerWhitelist
 */
public class TableModelUserWhitelist extends AbstractTableModel {
    ...
    // TODO: Implement (copy from TableModelPartnerWhitelist)
    @Override
