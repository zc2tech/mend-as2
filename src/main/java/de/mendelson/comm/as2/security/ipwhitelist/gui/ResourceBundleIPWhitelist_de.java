...
public class ResourceBundleIPWhitelist_de extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {ResourceBundleIPWhitelist.SETTINGS_ENABLE_SYS_API, "Für System-API aktivieren (/sysapi/v1/*)"},
        {ResourceBundleIPWhitelist.SETTINGS_ENABLE_USER_API, "Für Benutzer-API aktivieren (/userapi/*)"},
