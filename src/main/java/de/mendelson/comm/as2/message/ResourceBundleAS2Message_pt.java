//$Header: /as2/de/mendelson/comm/as2/message/ResourceBundleAS2Message_pt.java 2     9/12/24 16:02 Heller $
...
* @version $Revision: 2 $
*/
public class ResourceBundleAS2Message_pt extends MecResourceBundle {
	...
	private static final Object[][] CONTENTS = {
		...
		{"compression.1", "Nenhum"},
		{"signature.1", "Sem assinatura"},
		{"compression.0", "Desconhecido"},
		{"compression.2", "ZLIB"},
		{"signature.4", "SHA-224"},
		{"signature.5", "SHA-256"},
		{"signature.2", "SHA-1"},
