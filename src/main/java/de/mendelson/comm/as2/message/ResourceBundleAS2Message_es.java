//$Header: /as2/de/mendelson/comm/as2/message/ResourceBundleAS2Message_es.java 2     9/12/24 16:02 Heller $
...
* @version $Revision: 2 $
*/
public class ResourceBundleAS2Message_es extends MecResourceBundle {
	...
	private static final Object[][] CONTENTS = {
		{"signature.0", "Desconocido"},
		{"compression.1", "Ninguno"},
		{"signature.1", "Sin firma"},
		{"compression.0", "Desconocido"},
		{"compression.2", "ZLIB"},
		{"signature.4", "SHA-224"},
		{"signature.5", "SHA-256"},
		{"signature.2", "SHA-1"},
		...
		{"direction.0", "Desconocido"},
		{"direction.1", "Entrante"},
