...
/**
 * POJO representing a single user API authentication credential.
 * Can be either Basic Auth (username/password) or Certificate Auth (fingerprint).
 * Pattern based on UserTrackerAuthCredential.
 */
public class UserApiAuthCredential implements Serializable {
     ...
     * Default constructor
     */
    public UserApiAuthCredential() {
    }

    /**
     * Copy constructor
     */
    public UserApiAuthCredential(UserApiAuthCredential source) {
        if (source != null) {
