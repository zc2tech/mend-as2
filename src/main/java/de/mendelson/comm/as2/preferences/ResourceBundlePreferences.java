...
public class ResourceBundlePreferences extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        //Inbound Authentication preferences
        {"inboundauth.title", "Inbound Authentication"},
        {"inboundauth.info", "Configure authentication required for incoming AS2 messages. Messages matching ANY configured credential will be accepted."},
        {"inboundauth.mode.none", "No Authentication"},
        {"inboundauth.mode.basic", "Basic Authentication (Multiple Credentials)"},
        {"inboundauth.mode.cert", "Certificate Authentication (Multiple Certificates)"},
        {"inboundauth.basic.title", "Basic Auth Credentials"},
        {"inboundauth.basic.col.username", "Username"},
        {"inboundauth.basic.col.password", "Password"},
        {"inboundauth.cert.title", "Certificate Auth"},
        {"inboundauth.cert.col.alias", "Certificate Alias"},
        {"inboundauth.button.add", "Add"},
        {"inboundauth.button.remove", "Remove"},
        {"inboundauth.enable.basic", "Enable Basic Authentication"},
        {"inboundauth.enable.cert", "Enable Certificate Authentication"},
        {"inboundauth.tab.basic", "Basic Authentication"},
        {"inboundauth.tab.cert", "Certificate Authentication"},
    };
}
