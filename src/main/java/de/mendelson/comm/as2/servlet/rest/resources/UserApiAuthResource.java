...
/**
 * REST API for user-specific API authentication configuration.
 * All endpoints require authentication and operate on the current user's data.
 */
@Path("/user/api-auth")
public class UserApiAuthResource {

    @Context
    private SecurityContext securityContext;

    /**
     * Get current user's API auth configuration (toggles + all credentials).
     * GET /user/api-auth/config
     */
    @GET
    @Path("/config")
    ...
    public Response getConfig() {
        try {
            ...
            UserApiAuthConfig config = new UserApiAuthConfig();
    ...
    /**
     * Save current user's API auth configuration.
     * POST /user/api-auth/config
     */
    @POST
    @Path("/config")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response saveConfig(UserApiAuthConfig config) {
        ...
        try {
            ...
            UserApiAuthConfig savedConfig = new UserApiAuthConfig();
    ...
    /**
     * DTO for API auth configuration (used in JSON serialization).
     */
    public static class UserApiAuthConfig {
        ...
        private List<UserApiAuthCredential> credentialsList = new ArrayList<>();
        ...
        public List<UserApiAuthCredential> getCredentialsList() {
            return credentialsList;
        }

        public void setCredentialsList(List<UserApiAuthCredential> credentialsList) {
