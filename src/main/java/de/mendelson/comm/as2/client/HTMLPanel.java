...
public class HTMLPanel extends JPanel implements HyperlinkListener, PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        try {
            downloadedDataWriter = new FileWriter(java.net.URI.create(this.fallbackOnErrorURL).toURL().getFile());
    ...
    public Header[] setURL(String urlStr, String userAgent, String fallbackOnErrorURL) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            HttpPost filePost = new HttpPost(java.net.URI.create(urlStr).toURL().toExternalForm());
            filePost.addHeader("User-Agent", userAgent);
            try (CloseableHttpResponse httpResponse = (CloseableHttpResponse) httpClient.execute(filePost, response -> response)) {
            ...
            this.jEditorPane.setPage(java.net.URI.create(urlStr).toURL());
        } catch (Throwable e) {
            try {
