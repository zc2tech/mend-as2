...
public class ResourceBundleAS2Gui extends MecResourceBundle {
    ...
    private static final Object[][] CONTENTS = {
        ...
        {"menu.file.certificate.ssl", "Sys TLS"},
        {"menu.file.certificates.tls.my", "My TLS Certificates"},
        ...
        {"menu.system", "System"},
        {"menu.system.serverinfo", "Display HTTP server configuration"},
        {"menu.system.events", "System events"},
        {"menu.system.searchlog", "Search in server log"},
        {"menu.userpreference", "My Preferences"},
