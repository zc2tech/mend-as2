//$Header: /as2/de/mendelson/util/security/signature/ResourceBundleSignatureAS2_fr.java 3     16/08/24 8:23 Heller $
 ...
 * @version $Revision: 3 $
 */
public class ResourceBundleSignatureAS2_fr extends MecResourceBundle {
    ...
    static final Object[][] CONTENTS = {
        {"signature." + SignatureConstantsAS2.SIGNATURE_UNKNOWN, "Inconnu"},
        {"signature." + SignatureConstantsAS2.SIGNATURE_NONE, "Aucune signature"},
