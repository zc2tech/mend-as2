 ...
 * @version $Revision: 5 $
 */
public class ListCellRendererEncryption extends JLabel implements ListCellRenderer<EncryptionDisplay>{
    ...
    public Component getListCellRendererComponent(
            JList<? extends EncryptionDisplay> list, EncryptionDisplay value, int index, boolean isSelected, boolean cellHasFocus) {
