//$Header: /as2/de/mendelson/util/clientserver/gui/ResourceBundleLogin_fr.java 1     12/06/24 16:25 Heller $
 ...
 * @version $Revision: 1 $
 */
public class ResourceBundleLogin_fr extends MecResourceBundle {
