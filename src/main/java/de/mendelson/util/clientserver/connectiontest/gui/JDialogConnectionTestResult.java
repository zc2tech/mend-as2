...
public class JDialogConnectionTestResult extends JDialog {
    ...
    private void initComponents() {
        ...
        jLabelIPConnection.setText(JDialogConnectionTestResult.rb.getResourceString("label.connection.established"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabelRemoteCertificatesAvailableLocal.setText(JDialogConnectionTestResult.rb.getResourceString("label.certificates.available.local"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabelRemoteOFTPService.setText(JDialogConnectionTestResult.rb.getResourceString("label.running.oftpservice"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jButtonImportCertificates.setText(JDialogConnectionTestResult.rb.getResourceString( "button.viewcert"));
        ...
        jButtonClose.setText(JDialogConnectionTestResult.rb.getResourceString( "button.close"));
