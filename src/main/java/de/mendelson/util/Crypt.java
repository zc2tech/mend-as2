...
public class Crypt{
    ...
    private static final byte[] InitialTr = {
    ...
    private static final byte[] FinalTr = {
    ...
    private static final byte[] KeyTr1 = {
    ...
    private static final byte[] KeyTr2 = {
