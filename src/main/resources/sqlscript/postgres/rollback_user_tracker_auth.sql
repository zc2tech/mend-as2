...
DROP TABLE IF EXISTS user_tracker_auth_credentials CASCADE;

-- Step 2: Remove columns from webui_users table
ALTER TABLE webui_users
DROP COLUMN IF EXISTS tracker_auth_basic_enabled,
DROP COLUMN IF EXISTS tracker_auth_cert_enabled;
